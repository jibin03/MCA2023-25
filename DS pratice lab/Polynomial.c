...
int mulPolynomial(struct poly polynomial1[], int size1, struct poly polynomial2[], int size2, struct poly res[])
 {
...
int main()
{
  ...
  /*  sres = mulPolynomial(poly1, s1, poly2, s2, res);
